...
extern const uint8_t ulp_main_bin_start[] asm("_binary__pio_build_esp32dev_ulp_app_ulp_main_bin_start");
extern const uint8_t ulp_main_bin_end[]   asm("_binary__pio_build_esp32dev_ulp_app_ulp_main_bin_end");
